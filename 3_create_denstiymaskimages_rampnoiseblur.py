...
INPUT_JSON = "2_horse_uv_faces_triangulated.json"

OUTPUT_TILE_1001 = "horse_density_1001.png"
OUTPUT_TILE_1002 = "horse_density_1002.png"

OUTPUT_TILE_1001_RESULT = "horse_density_1001_result.png"
OUTPUT_TILE_1002_RESULT = "horse_density_1002_result.png"
...
# Apply per UDIM
img_1001_result = apply_ramp_and_noise(img_1001.copy())
img_1002_result = apply_ramp_and_noise(img_1002.copy())

# Final blur pass
img_1001_result = img_1001_result.filter(ImageFilter.GaussianBlur(BLUR_RADIUS))
img_1002_result = img_1002_result.filter(ImageFilter.GaussianBlur(BLUR_RADIUS))

img_1001_result.save(OUTPUT_TILE_1001_RESULT)
img_1002_result.save(OUTPUT_TILE_1002_RESULT)

print("Procedural ramp + noise + blur refinement completed")
print(" -", OUTPUT_TILE_1001_RESULT)
print(" -", OUTPUT_TILE_1002_RESULT)
